...
def salvar_tarefa(usuario_id: str, descricao: str, prioridade: str = "normal", prazo: str = None):
    conn = sqlite3.connect(DB_PATH)
    cursor = conn.cursor()
    cursor.execute(
...
def concluir_tarefa(usuario_id: str, descricao_parcial: str):
    conn = sqlite3.connect(DB_PATH)
    cursor = conn.cursor()
    cursor.execute(
...
def salvar_lembrete(usuario_id: str, descricao: str, horario: str):
    conn = sqlite3.connect(DB_PATH)
    cursor = conn.cursor()
    cursor.execute(
...
def listar_lembretes(usuario_id: str):
    conn = sqlite3.connect(DB_PATH)
    cursor = conn.cursor()
    cursor.execute(
